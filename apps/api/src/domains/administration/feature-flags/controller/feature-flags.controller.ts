...
export class FeatureFlagsController extends BaseController {
  constructor(private readonly service: FeatureFlagsService = new FeatureFlagsService()) {
    super();
  }
  ...
  getAll = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data.items, 'FeatureFlags records retrieved', {
        page: data.page,
        limit: data.limit,
        total: data.total,
  ...
  getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'FeatureFlags record retrieved');
    } catch (err) {
      next(err);
    }
  };
  ...
  create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.created(res, data, 'FeatureFlags created successfully');
    } catch (err) {
      next(err);
    }
  };
  ...
  update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'FeatureFlags updated successfully');
    } catch (err) {
      next(err);
    }
  };
