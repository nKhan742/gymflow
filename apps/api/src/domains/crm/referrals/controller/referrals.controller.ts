...
export class ReferralsController extends BaseController {
  constructor(private readonly service: ReferralsService = new ReferralsService()) {
    super();
  }
  ...
  getAll = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data.items, 'Referrals records retrieved', {
        page: data.page,
        limit: data.limit,
        total: data.total,
  ...
  getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'Referrals record retrieved');
    } catch (err) {
      next(err);
    }
  };
  ...
  create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.created(res, data, 'Referrals created successfully');
    } catch (err) {
      next(err);
    }
  };
  ...
  update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'Referrals updated successfully');
    } catch (err) {
      next(err);
    }
  };
