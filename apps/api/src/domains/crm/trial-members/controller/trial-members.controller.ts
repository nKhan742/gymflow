...
export class TrialMembersController extends BaseController {
  constructor(private readonly service: TrialMembersService = new TrialMembersService()) {
    super();
  }
  ...
  getAll = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data.items, 'TrialMembers records retrieved', {
        page: data.page,
        limit: data.limit,
        total: data.total,
  ...
  getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'TrialMembers record retrieved');
    } catch (err) {
      next(err);
    }
  };
  ...
  create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.created(res, data, 'TrialMembers created successfully');
    } catch (err) {
      next(err);
    }
  };
  ...
  update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'TrialMembers updated successfully');
    } catch (err) {
      next(err);
    }
  };
