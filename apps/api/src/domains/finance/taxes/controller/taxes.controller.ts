...
export class TaxesController extends BaseController {
  constructor(private readonly service: TaxesService = new TaxesService()) {
    super();
  }
  ...
  getAll = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data.items, 'Taxes records retrieved', {
        page: data.page,
        limit: data.limit,
        total: data.total,
  ...
  getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'Taxes record retrieved');
    } catch (err) {
      next(err);
    }
  };
  ...
  create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.created(res, data, 'Taxes created successfully');
    } catch (err) {
      next(err);
    }
  };
  ...
  update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'Taxes updated successfully');
    } catch (err) {
      next(err);
    }
  };
