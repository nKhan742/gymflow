...
export class AttendanceReportsController extends BaseController {
  constructor(private readonly service: AttendanceReportsService = new AttendanceReportsService()) {
    super();
  }
  ...
  getAll = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data.items, 'AttendanceReports records retrieved', {
        page: data.page,
        limit: data.limit,
        total: data.total,
  ...
  getById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'AttendanceReports record retrieved');
    } catch (err) {
      next(err);
    }
  };
  ...
  create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.created(res, data, 'AttendanceReports created successfully');
    } catch (err) {
      next(err);
    }
  };
  ...
  update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      return this.ok(res, data, 'AttendanceReports updated successfully');
    } catch (err) {
      next(err);
    }
  };
