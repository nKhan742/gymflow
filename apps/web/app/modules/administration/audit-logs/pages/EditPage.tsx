...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Audit Logs Item Alpha');
  ...
  const handleUpdate = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success('Audit Logs updated successfully');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this audit logs record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Audit Logs Name</label>
                <Input
                  value={name}
