...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Roles Item Alpha');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this roles record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Roles Name</label>
                <Input
                  value={name}
            ...
            <CardFooter className="flex justify-end gap-2.5">
              <Button variant="outline" type="button" onClick={() => navigate('/administration/roles')}>
                Cancel
              </Button>
