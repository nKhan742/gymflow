  ...
  const loadRoles = async () => {
    ...
    try {
      ...
      if (rolesRes && rolesRes.ok) {
        ...
        // Sort ascending by hierarchyTier (Tier 1 -> Tier 2 -> Tier 3 -> Tier 4 -> Tier 5)
        enriched.sort((a: any, b: any) => {
          const tierA = typeof a.hierarchyTier === 'number' ? a.hierarchyTier : 99;
          const tierB = typeof b.hierarchyTier === 'number' ? b.hierarchyTier : 99;
          if (tierA !== tierB) {
            return tierA - tierB;
          }
          return (a.roleName || a.name || '').localeCompare(b.roleName || b.name || '');
        });
