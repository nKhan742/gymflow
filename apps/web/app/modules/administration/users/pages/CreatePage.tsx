...
export const CreatePage: React.FC = () => {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Create Users"
        subtitle="Configure new users record with validation and role permissions."
        actions={
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Fill out the parameters for this users.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Users Title / Name</label>
                <Input
                  placeholder="e.g. Standard Users Protocol"
                  value={name}
