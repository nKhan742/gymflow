...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Attendance Analytics Item Alpha');
  ...
  const handleUpdate = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success('Attendance Analytics updated successfully');
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Edit Attendance Analytics"
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this attendance analytics record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Attendance Analytics Name</label>
                <Input
                  value={name}
