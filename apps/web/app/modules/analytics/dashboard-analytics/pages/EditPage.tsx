...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Dashboard Analytics Item Alpha');
  ...
  const handleUpdate = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success('Dashboard Analytics updated successfully');
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Edit Dashboard Analytics"
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this dashboard analytics record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Dashboard Analytics Name</label>
                <Input
                  value={name}
