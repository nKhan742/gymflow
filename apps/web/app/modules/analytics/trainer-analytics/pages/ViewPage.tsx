  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle={`${model.coachingSpecialty} • Cadence: ${model.reportingPeriod} • Campus: ${model.branchName || 'Main Facility'}`}
        actions={
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-xs text-muted-foreground space-y-2 leading-relaxed">
              ...
              <div className="pt-2 border-t border-border space-y-1 font-mono text-[10px]">
                ...
                <div>Campus Scope: <strong>{model.branchName || 'Main Facility'}</strong></div>
              </div>
            </div>
          </CardContent>
        </Card>
