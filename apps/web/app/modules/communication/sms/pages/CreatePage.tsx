...
export const CreatePage: React.FC = () => {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Create Sms"
        subtitle="Configure new sms record with validation and role permissions."
        actions={
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Fill out the parameters for this sms.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Sms Title / Name</label>
                <Input
                  placeholder="e.g. Standard Sms Protocol"
                  value={name}
