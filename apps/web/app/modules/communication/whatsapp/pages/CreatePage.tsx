...
export const CreatePage: React.FC = () => {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Create Whatsapp"
        subtitle="Configure new whatsapp record with validation and role permissions."
        actions={
      ...
      <div className="max-w-2xl">
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              <CardTitle>Whatsapp Details</CardTitle>
              <CardDescription>Fill out the parameters for this whatsapp.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Whatsapp Title / Name</label>
                <Input
                  placeholder="e.g. Standard Whatsapp Protocol"
                  value={name}
