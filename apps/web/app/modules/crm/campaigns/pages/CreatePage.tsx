  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Configure new campaigns record with validation and role permissions."
        actions={
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Fill out the parameters for this campaigns.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Campaigns Title / Name</label>
                <Input
                  placeholder="e.g. Standard Campaigns Protocol"
                  value={name}
