    ...
    <PageContainer>
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
                  ...
                  <span className="flex items-center gap-1">
                    <Building2 className="w-3.5 h-3.5 text-blue-500" /> {followUp.branchName || 'Downtown Flagship'}
                  </span>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="p-4 bg-card border border-border/80 shadow-2xs">
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">{followUp.branchName || 'Downtown Flagship'}</p>
        </Card>
