...
export const CreatePage: React.FC = () => {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Create Leads"
        subtitle="Configure new leads record with validation and role permissions."
        actions={
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Fill out the parameters for this leads.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Leads Title / Name</label>
                <Input
                  placeholder="e.g. Standard Leads Protocol"
                  value={name}
