  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Configure new referrals record with validation and role permissions."
        actions={
      ...
      <div className="max-w-2xl">
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              <CardTitle>Referrals Details</CardTitle>
              <CardDescription>Fill out the parameters for this referrals.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Referrals Title / Name</label>
                <Input
                  placeholder="e.g. Standard Referrals Protocol"
                  value={name}
