...
export const CreatePage: React.FC = () => {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Create Tasks"
        subtitle="Configure new tasks record with validation and role permissions."
        actions={
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Fill out the parameters for this tasks.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Tasks Title / Name</label>
                <Input
                  placeholder="e.g. Standard Tasks Protocol"
                  value={name}
