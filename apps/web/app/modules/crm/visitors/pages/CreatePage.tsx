  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Configure new visitors record with validation and role permissions."
        actions={
      ...
      <div className="max-w-2xl">
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              <CardTitle>Visitors Details</CardTitle>
              <CardDescription>Fill out the parameters for this visitors.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Visitors Title / Name</label>
                <Input
                  placeholder="e.g. Standard Visitors Protocol"
                  value={name}
