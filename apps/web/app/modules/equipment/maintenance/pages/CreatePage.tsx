  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Configure new maintenance record with validation and role permissions."
        actions={
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Fill out the parameters for this maintenance.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Maintenance Title / Name</label>
                <Input
                  placeholder="e.g. Standard Maintenance Protocol"
                  value={name}
