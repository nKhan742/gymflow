...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Maintenance Item Alpha');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this maintenance record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Maintenance Name</label>
                <Input
                  value={name}
