  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Configure new expenses record with validation and role permissions."
        actions={
          <Button variant="outline" size="sm" className="gap-1.5" onClick={() => navigate('/finance/expenses')}>
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Fill out the parameters for this expenses.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Expenses Title / Name</label>
                <Input
                  placeholder="e.g. Standard Expenses Protocol"
                  value={name}
