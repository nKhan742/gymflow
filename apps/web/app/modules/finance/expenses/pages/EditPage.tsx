...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Expenses Item Alpha');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this expenses record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Expenses Name</label>
                <Input
                  value={name}
