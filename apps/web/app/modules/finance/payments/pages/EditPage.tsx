...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Payments Item Alpha');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this payments record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Payments Name</label>
                <Input
                  value={name}
