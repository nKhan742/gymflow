...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Trainer Commission Item Alpha');
  ...
  const handleUpdate = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success('Trainer Commission updated successfully');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this trainer commission record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Trainer Commission Name</label>
                <Input
                  value={name}
