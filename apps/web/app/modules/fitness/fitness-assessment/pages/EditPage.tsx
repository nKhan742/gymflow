...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Fitness Assessment Item Alpha');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this fitness assessment record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Fitness Assessment Name</label>
                <Input
                  value={name}
