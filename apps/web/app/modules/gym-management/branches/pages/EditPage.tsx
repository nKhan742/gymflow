...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Branches Item Alpha');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this branches record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Branches Name</label>
                <Input
                  value={name}
