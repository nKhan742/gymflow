...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Gym Profile Item Alpha');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this gym profile record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Gym Profile Name</label>
                <Input
                  value={name}
