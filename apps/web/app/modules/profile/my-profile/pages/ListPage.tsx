    ...
    try {
      ...
      if (authUserRaw) {
        ...
        setProfile((prev) => ({
          ...
          jobTitle: authUser.roleName || (authUser.role === 'SUPER_ADMIN' ? 'Super Administrator' : prev.jobTitle),
            ...
            <div className="flex items-end gap-4">
              ...
              <div className="space-y-1 pb-1">
                ...
                <p className="text-xs text-muted-foreground font-medium flex items-center gap-1.5">
                  ...
                  {profile?.jobTitle || 'Facility Operator'} • <strong className="text-foreground">{profile?.department || 'Operations'}</strong> • {profile?.branchName || 'Downtown Flagship'}
                </p>
              </div>
            </div>
