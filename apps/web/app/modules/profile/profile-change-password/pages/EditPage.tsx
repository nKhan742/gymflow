...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Profile Change Password Item Alpha');
  ...
  const handleUpdate = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success('Profile Change Password updated successfully');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this profile change password record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Profile Change Password Name</label>
                <Input
                  value={name}
