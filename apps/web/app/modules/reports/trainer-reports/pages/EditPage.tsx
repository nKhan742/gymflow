...
export const EditPage: React.FC = () => {
  ...
  const [name, setName] = useState('Trainer Reports Item Alpha');
  ...
  const handleUpdate = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.success('Trainer Reports updated successfully');
        ...
        <form onSubmit={handleUpdate}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Make changes to this trainer reports record.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Trainer Reports Name</label>
                <Input
                  value={name}
