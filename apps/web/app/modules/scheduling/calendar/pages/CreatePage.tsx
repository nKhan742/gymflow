  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Configure new calendar record with validation and role permissions."
        actions={
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Fill out the parameters for this calendar.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Calendar Title / Name</label>
                <Input
                  placeholder="e.g. Standard Calendar Protocol"
                  value={name}
