  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle="Configure new resource booking record with validation and role permissions."
        actions={
      ...
      <div className="max-w-2xl">
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              <CardTitle>Resource Booking Details</CardTitle>
              <CardDescription>Fill out the parameters for this resource booking.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Resource Booking Title / Name</label>
                <Input
                  placeholder="e.g. Standard Resource Booking Protocol"
                  value={name}
            ...
            <CardFooter className="flex justify-end gap-2.5">
              ...
              <Button type="submit" loading={loading} className="gap-1.5">
                ...
                <span>Save Resource Booking</span>
              </Button>
            </CardFooter>
          </Card>
        </form>
