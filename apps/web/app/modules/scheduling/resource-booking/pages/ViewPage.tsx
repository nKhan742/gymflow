    ...
    <PageContainer>
          ...
          <div className="md:col-span-2 p-6 flex flex-col justify-between">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">• {booking.branchName || 'Main Facility'}</span>
              </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="p-4 bg-card border border-border/80 shadow-2xs">
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">{booking.branchName || 'Main Facility'}</p>
        </Card>
